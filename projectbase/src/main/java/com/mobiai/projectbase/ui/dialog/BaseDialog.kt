package com.mobiai.projectbase.ui.dialog
...
open class BaseDialog(context: Context) : Dialog(context, com.google.android.material.R.style.AlertDialog_AppCompat) {
    init {
